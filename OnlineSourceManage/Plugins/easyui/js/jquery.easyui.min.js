...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:500,missingMessage:"请先输入查询的内容",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
$(this).tooltip("tip").css({color:"#fff",borderColor:"#ccc",backgroundColor:"#009688"});
},onHide:function(){
$(this).tooltip("destroy");
...
_842._outerWidth(opts.width)._outerHeight(34);
_844._outerWidth(_842.width()-_846);
_844.css({height:32+"px",lineHeight:32+"px"});
_842.css({"border-radius":4+"px"});
_845._outerHeight(32);
